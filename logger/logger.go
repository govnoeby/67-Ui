// Package logger provides logging functionality for the 67-Ui panel with
...
const (
	...
	logFileName      = "67-ui.log"           // Log file name
...
func InitLogger(level logging.Level) {
	newLogger := logging.MustGetLogger("67-ui")
	...
	if consoleBackend := initDefaultBackend(); consoleBackend != nil {
		...
		leveledBackend.SetLevel(level, "67-ui")
	...
	if fileBackend := initFileBackend(); fileBackend != nil {
		...
		leveledBackend.SetLevel(logging.DEBUG, "67-ui")
		backends = append(backends, leveledBackend)
	}
