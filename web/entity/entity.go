// Package entity defines data structures and entities used by the web layer of the 67-Ui panel.
package entity
...
// AllSetting contains all configuration settings for the 67-Ui panel including web server, Telegram bot, and subscription settings.
